function [Q] = tt_sample_lagr_diff(u, x, y, dindex)
% Derivative of Lagrange interpolation of u onto a set of points y.
% Inputs:
%   u: tt_tensor or its core2cell
%   x: (d,1) cell of Cheb2 points in each dimension
%   y: (M,d) double of points
%   dindex: index of variable where the derivative should be computed
% Output:
